...
const WhyUs: React.FC = () => {
  ...
  if (!content) {
    return <section id="porque-nosotros" className="py-20 md:py-32 bg-dark-bg/50"><div className="container mx-auto px-6 text-center">Cargando...</div></section>;
  }

  return (
    <section id="porque-nosotros" className="py-20 md:py-32 bg-dark-bg/50">
